...
const AddCourse = () => {
   ...
   return (
      <div className='flex justify-center'>
         <Form className="mb-3 flex flex-col mt-10 justify-start items-center shadow-xl shadow-gray-500 bg-white p-5 w-[30%]" onSubmit={handleSubmit}>
            <Row className="mb-3 flex flex-col gap-2 justify-start items-center">
               <Form.Group as={Col} controlId="formGridJobType">
                  <Form.Label className='font-bold'>Course Type</Form.Label>
               ...
               <Form.Group className='font-bold' as={Col} controlId="formGridTitle">
               ...
               <Form.Group as={Col} controlId="formGridTitle">
                  <Form.Label className='font-bold'>Course Educator</Form.Label>
               ...
               <Form.Group as={Col} controlId="formGridTitle">
                  <Form.Label className='font-bold'>Course Price(Rs.)</Form.Label>
               ...
               <Form.Group as={Col} className="mb-3" controlId="formGridAddress2">
                  <Form.Label className='font-bold'>Course Description</Form.Label>
            ...
            <Row className="mb-3 flex justify-center">
               <Col xs={24} md={12} lg={8} className='w-full'>
                  <Button size='sm' className='w-full bg-violet-300 text-black' onClick={addInputGroup}>
                     ➕ Add Section
                  </Button>
               </Col>
            </Row>
