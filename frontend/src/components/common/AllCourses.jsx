...
const AllCourses = () => {
   ...
   return (
      <>
         <div className=" mt-4 flex items-center filter-container text-center">
            <p className="">Serach By: </p>
            <input
               type="text"
               placeholder="title"
               value={filterTitle}
         ...
         <div className="p-2 course-container">
            {allCourses?.length > 0 ? (
               allCourses
                  ...
                  .map((course, index) => (
                     <div key={course._id} className="course fade-in">
                        <div className="card1">
                           <div className="desc">
                              <h3>Modules</h3>
                           ...
                           <div className="details">
                              <div className="center ml-14">
                                 ...
                                 {user.userLoggedIn === true ? (
                                    ...
                                    <Link to={"/login"}>
                                       <Button className="course-button" variant="outline-dark" size="sm">
                                          Start Course
                                       </Button>
                                    </Link>
                                 )}
